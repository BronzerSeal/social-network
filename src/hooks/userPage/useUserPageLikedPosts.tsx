"use client";
import { getInfinityUserLikedPosts } from "@/actions/posts/getInfinityUserLikedPosts";
...
export const useUserPageLikedPosts = (userId: string) => {
  const {
    data: posts,
    isLoading,
    fetchNextPage,
    ...
    Cursor
  >({
    queryKey: ["posts", "user-page", "liked-posts"],
    queryFn: ({ pageParam }) =>
      getInfinityUserLikedPosts({
        cursor: pageParam,
        userId,
      }),
